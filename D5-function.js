...
function veRerse(string){
  let primo = string.shift();
  string.push(primo);
  return string
}

console.log(veRerse(pets));
/* ESERCIZIO 5
...
function addproprierty(array){
  for (let i = 0; i < array.length; i++) {
    array[i].licensePlate = "AB123KZ";
  }
  console.log(array);
}
...
function tRims(array){
  for (let i = 0; i < array.length; i++) {
      const justTrims = [];
      justTrims[i] = Object.assign(array[i].trims[0]);
  }
